namespace Altom.Editor
{
    ...
    {
        public static AltUnityInspectorPage _window;
        ...
        [UnityEditor.MenuItem("AltUnity Tools/AltUnity Inspector", false, 81)]
        public static void ShowWindow()
        {
            _window = (AltUnityInspectorPage)GetWindow(typeof(AltUnityInspectorPage));
            _window.minSize = new UnityEngine.Vector2(300, 300);

            UnityEngine.GUIContent titleContent = new UnityEngine.GUIContent("AltUnity Inspector");
        ...
        private void OnFocus()
        {
            ...
            if (image == null)
            {
                var findImage = UnityEditor.AssetDatabase.FindAssets("AltUnityInspectorPNG");
